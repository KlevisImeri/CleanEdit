...
<p align="center">
  <img src="vue/src/assets/black_border.png" alt="logo" width="200px">
  <br>
...
- Somehow use AI to reason about the video at that moment 
    ...
    - Audio 
        - Transcribing video
        - Reasoning what is listening to
- Ask reasoning models which parts to keep which not.

- Fix editor
- Load Timeline after the Video component has loaded the video
- Fix Timeline
